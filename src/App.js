...
function App() {
  ...
  return (<div className="App">
        ...
        <div className="corretor-section">
          <h2>Conheça o curso CORRETOR CRECI TTI, uma parceria autorizada de vendas do Instituto Monitor. <br/>Matrículas
            abertas!</h2>
          {/*<a href="/pagina-de-matricula" className="matricule-se-button">*/}
          {/*  Matricule-se*/}
          {/*</a>*/}
        ...
        <footer className="footer">
          ...
          <div className="social-media">
            <h3>Redes Sociais</h3>
            <a href="https://www.instagram.com/ritaleitecorretora/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="rights">
          ...
          <p>Desenvolvido por: <a href="https://www.seusite.com" target="_blank" rel="noopener noreferrer"></a>
          </p>
        </div>
      </div>);
}
